...
def pretrained_efficientnet_b0(include_top, dynamic_shape=False, **kwargs):
    ...
    return EfficientNetB0(include_top, weights="efficientnet-b0_noisy-student.h5", input_shape=[None, None, 3] if dynamic_shape else None, **kwargs)
