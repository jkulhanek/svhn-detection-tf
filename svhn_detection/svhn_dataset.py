...
class SVHN:
    ...
    def __init__(self):
        ...
        for dataset in ["train", "dev", "test"]:
            ...
            file_path = "data/svhn.{}.tfrecord".format(dataset)
            if not os.path.exists(file_path):
                print("Downloading file {}...".format(path), file=sys.stderr)
                urllib.request.urlretrieve("{}/{}".format(self._URL, path), filename=file_path)

            setattr(self, dataset, tf.data.TFRecordDataset(file_path))
